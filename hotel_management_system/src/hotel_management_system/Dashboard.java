...
public class Dashboard extends JFrame implements ActionListener
{
	...
	Dashboard()
	{
		...
		ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("hotel2.jpeg"));
		Image i2 = i1.getImage().getScaledInstance(1534, 830,Image.SCALE_DEFAULT);
